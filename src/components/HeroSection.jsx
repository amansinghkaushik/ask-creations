...
export default function HeroSection() {
  ...
  // Locked Cutout Position & Dimensions (percentages)
  const cutout = {
    top: 16,     // Y position (%)
    left: 40,    // X position (%)
    width: 30,   // Length / Width L (%)
    height: 20,  // Breadth / Height B (%)
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full flex flex-col justify-end">
        ...
        <div className="hero-left-para absolute left-6 md:left-10 lg:left-12 top-[14%] -translate-y-1/2 max-w-[500px] md:max-w-[600px] z-20 pointer-events-auto overflow-hidden">
          <p className="text-white/95 font-normal text-xs sm:text-sm md:text-base leading-tight tracking-wide">
        ...
        <div className="absolute right-6 md:right-10 lg:right-12 top-[20%] -translate-y-1/2 z-20 flex flex-col items-center gap-10 sm:gap-10 pointer-events-auto">
          <a href="https://www.linkedin.com/in/amansinghkaushik/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="hero-social-icon hover:scale-110 transition-transform">
          ...
          <a href="https://github.com/amansinghkaushik" target="_blank" rel="noreferrer" aria-label="GitHub" className="hero-social-icon hover:scale-110 transition-transform">
            <svg className="w-5 h-5 fill-current text-white hover:text-white/80 transition-colors" viewBox="0 0 24 24">
          ...
          <a href="https://www.instagram.com/aman_singh_kaushik_/" target="_blank" rel="noreferrer" aria-label="Instagram" className="hero-social-icon hover:scale-110 transition-transform">
            <svg className="w-5 h-5 fill-current text-white hover:text-white/80 transition-colors" viewBox="0 0 24 24">
          ...
          <a href="https://whatsapp.com" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="hero-social-icon hover:scale-110 transition-transform">
            <svg className="w-5 h-5 fill-current text-white hover:text-white/80 transition-colors" viewBox="0 0 24 24">
        ...
        <div className="absolute top-[48%] -translate-y-1/2 w-full px-6 md:px-10 lg:px-12 z-20 flex justify-between items-center text-neutral-300 font-clash font-semibold text-xs tracking-wide uppercase overflow-hidden py-2">
        ...
        <div className="relative z-20 w-full px-6 md:px-10 lg:px-12 pb-0 flex flex-col justify-end pointer-events-none box-border max-w-full overflow-hidden">
          {/* Top Row: ASK on the Left + CTA Block on the Right */}
          <div className="w-full flex items-start justify-between">
            {/* Line 1: ASK */}
            <div className="hero-line-1 font-clash font-semibold text-white uppercase text-[235px] leading-[0.78] tracking-tight">
              ASK
            </div>

            {/* CTA Block & Avatar */}
            <div className="hero-cta-block flex flex-col items-end gap-3 pointer-events-auto pt-2">
              ...
              <Link to="/contact" className="bg-black text-white font-clash font-semibold text-base px-8 py-4 tracking-wider uppercase hover:bg-white hover:text-black transition-colors border border-white/10">
                GET IN TOUCH
              </Link>
            </div>
          </div>
          ...
          {/* Line 2: CREATIONS */}
          <div className="hero-line-2 font-clash font-semibold text-white uppercase text-[235px] leading-[0.78] w-full block whitespace-nowrap">
            CREATIONS
          </div>
        </div>
      </div>
