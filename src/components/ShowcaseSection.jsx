...
export default function ShowcaseSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-white text-black py-16 md:py-28 relative z-10 select-none overflow-hidden"
    >
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 md:px-12 lg:px-16">
